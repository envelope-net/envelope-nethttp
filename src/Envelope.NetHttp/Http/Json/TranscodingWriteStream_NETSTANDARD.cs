...
internal sealed class TranscodingWriteStream : Stream
{
	...
	public override Task WriteAsync(byte[] buffer, int offset, int count, CancellationToken cancellationToken)
	{
		...
		return WriteAsyncCoreAsync(bufferSegment, cancellationToken);
	}

	private async Task WriteAsyncCoreAsync(ArraySegment<byte> bufferSegment, CancellationToken cancellationToken)
	{
